...
columns_2 = Dict(TRAIT_NAME => 1, CHR_COLON_POS => 3, ODD_RATIO => 4, CI_LOW => 5, CI_HIGH => 6, PVAL => 7, EFFECT_ALLELE => 8, OTHER_ALLELE => 9)
sep = " "
trait_name = "trait"
chr = 9
tss = 8764
...
str_1 = "trait 9 8765 0.25 0.09 1e-6 A C"
str_2 = "trait rs8756 9:8765 1.5 1.2 1.8 1.2e-6 A C"
